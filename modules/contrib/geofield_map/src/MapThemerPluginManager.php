...
class MapThemerPluginManager extends DefaultPluginManager {
  ...
  /**
   * Constructor of the Geofield Map Themers plugin manager.
   *
  ...
  public function __construct(
    ...
    parent::__construct('Plugin/GeofieldMapThemer', $namespaces, $module_handler, MapThemerInterface::class, MapThemer::class, 'Drupal\geofield_map\Annotation\MapThemer');
